...
const MyOrder = () =>{
    ...
    const getOrderData = async() => {
        try{
            const response = await fetch(`https://bookstore-fd4d.onrender.com/api/auth/order/${params.id}/detail`,{
                method : "GET",
                headers : {
    ...
    const getBookData = async (id) => {
        try{
            ...
            const response = await fetch(`https://bookstore-fd4d.onrender.com/api/store/book/${id}`,{
                method : "GET",
                headers : {
                    Authorization : authToken
                }
