...
const AdminUsers = () =>{
    ...
    const getAllUsersData = async() => {
        try{
            const response = await fetch('https://bookstore-fd4d.onrender.com/api/admin/users',{
                method : "GET",
                headers : {
    ...
    const deleteUser = async(id) => {
        try{
            const response = await fetch(`https://bookstore-fd4d.onrender.com/api/admin/users/delete/${id}`,{
                method : "DELETE",
                headers : {
                    Authorization : authToken,
                }
